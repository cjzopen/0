...
<aside aria-hidden="true" id="contact-us-side">
  <div id="contact-us-side-title" class="bg-red text-white text-center px-3 py-2">
  ...
  <div id="contact-us-side-content" class="d-flex align-items-stretch">
    <div class="col-12 col-md-5 bg-blue text-white text-center px-5 py-4 d-flex align-items-center justify-content-center">
      <div>
        <div class="h4">立即與我們聯繫</div>
        <div><a href="tel:+886-2-2522-1351,,301">(02)2522-1351 轉 301</a></div>
      </div>
    </div>
    <div class="col-12 col-md-7 bg-gray">
      <div class="row no-gutters align-items-center p-3">
        ...
        <div class="col-10">
          <div class="sub-color"><a href="/consult/">表單諮詢</a></div>
      ...
      <div class="row no-gutters align-items-center p-3">
        ...
        <div class="col-10">
          <div class="sub-color"><a href="mailto:jenny@ares.com.tw">Email</a></div>
...
<footer id="footer" class="d-print-none" itemscope itemtype="http://schema.org/WPFooter">
  <a id="back-to-top" href="#all" title="Back to top" role="button">
  ...
  <div id="social-btn">
    <div class="social-wrap">
      <ul>
        <li class="mt-3">
          <a href="https://www.youtube.com/user/AresTaiwan" rel="noopener noreferrer external" target="_blank" accesskey="y" title="youtube頻道">
        ...
        <li class="mt-3">
          <a href="https://www.facebook.com/AresInternational/" rel="noopener noreferrer external" target="_blank" title="資通粉絲團">
            <svg width="48" height="48" viewBox="-12 -12 48 48">
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="title h4 mt-4">認識 PKI</div>
        <ul>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/know-pki/">什麼是 PKI</a></li>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/know-pki/#why">為何需要 PKI</a></li>
        </ul>
      </div>
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="title h4 mt-4">產品介紹</div>
        <ul>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/products/">資通 uPKI</a></li>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/products/upki/">安控解決方案</a></li>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/products/cs/">資料加密及遮罩伺服器</a></li>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/products/uiam/">身分識別及存取管理系統</a></li>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/products/usp/">薪資密封袋</a></li>
        </ul>
      </div>
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="title h4 mt-4">最新消息</div>
        <ul>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/news/">最新消息</a></li>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/knowledge/">知識分享</a></li>
          <li><a class="p-2 p-lg-0 d-inline-block" href="https://www.ares.com.tw/epaper/subscribe/" rel="noopener noreferrer external" target="_blank">訂閱電子報</a></li>
        </ul>
      </div>
      <div class="col-12 col-sm-6 col-lg-3">
        <div class="title h4 mt-4">主題專區</div>
        <ul>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/pipa/">個資法專區</a></li>
          <li><a class="p-2 p-lg-0 d-inline-block" href="<?= HOST_LINK ?>/faq/">常見問題</a></li>
        </ul>
        <div class="title h4 mt-4">聯絡我們</div>
        <ul>
          <li>
            <a href="https://www.ares.com.tw">資通電腦官網</a>
          </li>
          <li>
            <svg fill="#FFFFFF" height="15" width="15" xmlns="http://www.w3.org/2000/svg">
              <use xlink:href="#email-icon" />
            </svg>
            <span>jenny@ares.com.tw</span>
          </li>
          <li>
            <a class="py-lg-0 py-2 d-inline-block" href="tel:+886-2-25221351,,301" title="+886-2-25221351 分機 301" aria-label="聯絡電話">
              ...
              <span>(02)25221351 分機 301</span>
            </a>
          </li>
          <li>Fax (02)25601735</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 col-sm-5 col-lg-6 order-1 order-sm-2 order-lg-2 text-sm-right">
          <a href="<?= HOST_LINK ?>/sitemap/" accesskey="m"><small>網站地圖</small></a> | <a href="https://www.ares.com.tw/privacy/" rel="noopener noreferrer external" target="_blank"><small>隱私權聲明</small></a>
        </div>
      </div>
    </div>
  </div>
