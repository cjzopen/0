...
?>
  ...
  <section>
    <div class="container">
      <h2 class="text-center">反洗錢系統可帶來什麼效益？</h2>
      <hr>
      <p>反洗錢、反詐騙金融犯罪解決方案已歷經數十年的市場實戰淬煉，藉此不斷地讓功能更趨完善，因此能夠因應全球與各國的主管機關要求。像是台灣金管會、美國財政部金融犯罪防制署（Financial Crimes Enforcement Network，FinCEN）、歐盟的第四部反洗錢指令（the Fourth Anti-Money Laundering Directive），以及 FATF 40+9 項建議（Financial Action Task Force，防制洗錢金融行動工作組織）等法規。加上資通電腦 <?= $age ?> 年的金融產業導入與顧問深厚經驗，可幫助金融業法遵總體成本下降 50％ 到 70％。</p>
    </div>
  </section>
  <section>
...
$thumbnail = array(
  ...
  array(
    ...
    'txt' => '<figure><figcaption>系統彙整各式交易資訊後會產生視覺化分析，方便使用者檢視所有金流動向，客戶或銀行交易對手間的關係和行為模式。'
  ),
  array(
