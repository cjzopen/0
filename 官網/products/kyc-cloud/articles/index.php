...
$pageName = "product";
$page['title']='KYC 相關文章| 資通電腦';
$page['description']='KYC 專業知識、技術交流與新聞等相關文章。';
$page['canonical']='https://www.ares.com.tw/products/kyc-cloud/articles/';
    ...
    <div class="ares-breadcrumb" aria-label="breadcrumb">
      <div class="container">
        <ul class="row" itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="../" itemprop="item"><span itemprop="name">KYC 混合雲</span></a>
