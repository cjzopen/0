...
$pageName = "product";
$page['title']='金融銀行財務交易系統-免費諮詢|ARES Treasury System資通電腦';
$page['description']='想要找到一套財務交易系統貫穿金融前中後台金融作業系統？請填寫服務表單留下聯絡資訊，將有專員盡速與您聯繫提供服務。';
    ...
    <div class="ares-breadcrumb" aria-label="breadcrumb">
      <div class="container">
        <ul class="row" itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="../" itemprop="item"><span itemprop="name">財務交易系統</span></a>
...
?>
  ...
  <section id="consult">
    ...
    <hr>
    <form id="consult_form" method="post" name="consult_form" onsubmit="return formCheck('ARES Treasury System');">
<?php
