...
$pageName = "product";
$page['title']='ARES Nuntio 免費諮詢|資通電腦';
$page['description']='想知道如何讓法規申報更順暢嗎？請填寫服務表單留下聯絡資訊，將有專員盡速與您聯繫提供服務。';
...
?>
  ...
  <section id="consult" class="contact-area-hide">
    ...
    <hr>
    <form id="consult_form" method="post" name="consult_form" onsubmit="return formCheck('ARES Nuntio');">
<?php
