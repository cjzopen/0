...
$pageName = "product";
$page['title']='ISDA SIMM免費諮詢|資通電腦';
$page['description']='線上免費諮詢';
    ...
    <div class="ares-breadcrumb" aria-label="breadcrumb">
      <div class="container">
        <ul class="row" itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="../" itemprop="item"><span itemprop="name">ISDA SIMM</span></a>
...
?>
  <section id="consult" class="contact-area-hide">
    ...
    <hr>
    <form id="consult_form" method="post" name="consult_form" onsubmit="return formCheck('ISDASIMM');">
<?php
