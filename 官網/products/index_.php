...
.product-button>[role="button"].active{
  color:var(--white);
  background-color:var(--blue);
  pointer-events:none;
}
.product-button>[role="button"].active::after{
  content:'';
  position: absolute;
  left: 50%;
  top:100%;
...
[data-labelledby] .border, .temp-labelledby .border{
  border-color:var(--blue)!important;
}
</style>
      ...
      <div class="container">
        ...
        <div id="business">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#cimes" id="cimes" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="cimes"><span>ciMes 製造執行系統</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#hcp" id="hcp" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="hcp"><span>HCP 人力資產規劃</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#oracle" id="oracle" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="oracle"><span>Oracle ERP 企業資源規劃</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#財報編製工具" id="財報編製工具" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="財報編製工具"><span>CaseWare 財報編製工具</span></a>
            </div>
            <!-- ================ -->
            <div class="col-12 mb-3" data-labelledby="cimes">
            ...
            <div class="col-12 mb-3" data-labelledby="hcp">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="oracle">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="財報編製工具">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <!-- button area, max is 4 -->
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#egui" id="egui" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="egui"><span>eGUI 電子發票</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#gv" id="gv" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="gv"><span>GV 統一發票管理</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#lt" id="lt" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="lt"><span>NM / GIB / 十號公報</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#crm" id="crm" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="crm"><span>GD-CRM 客戶關係管理</span></a>
            </div>
            <!-- ================= -->
            <div class="col-12 mb-3" data-labelledby="egui">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="gv">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="lt">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="crm">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <!-- button area, max is 4 -->
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#recruiting" id="recruiting" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="recruiting"><span>招募管理系統</span></a>
            </div>
            <!-- ================= -->
            <div class="col-12 mb-3" data-labelledby="recruiting">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
        ...
        <div id="security">
          ...
          <div class="row">
            <!-- button area, max is 4 -->
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#arespp" id="arespp" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="arespp"><span>ARES PP 隱私保鑣</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#fortify" id="fortify" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="fortify"><span>Fortify 原始碼檢測工具</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#comodo" id="comodo" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="comodo"><span>Comodo 安全管理平台</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#upki" id="upki" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="upki"><span>uPKI 安控元件</span></a>
            </div>
            <!-- ================ -->
            <div class="col-12 mb-3" data-labelledby="arespp">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="fortify">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="comodo">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="upki">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <!-- button area, max is 4 -->
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#knowbe4" id="knowbe4" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="knowbe4"><span>KnowBe4 資安課程平台</span></a>
            </div>
            <!-- ================= -->
            <div class="col-12 mb-3" data-labelledby="knowbe4">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
        ...
        <div id="financial">
          ...
          <div class="row">
            <!-- button area, max is 4 -->
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#afeis" id="afeis" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="afeis"><span>國內外匯電腦整合系統</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#earesbank" id="earesbank" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="earesbank"><span>海外分行核心系統</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#衍生性金融商品評價" id="衍生性金融商品評價" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="衍生性金融商品評價"><span>衍生性金融商品評價</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#法規報表申報" id="法規報表申報" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="法規報表申報"><span>法規報表申報</span></a>
            </div>
            <!-- ================ -->
            <div class="col-12 mb-3" data-labelledby="afeis">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="earesbank">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="衍生性金融商品評價">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="法規報表申報">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <!-- button area, max is 4 -->
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#財務交易系統" id="財務交易系統" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="財務交易系統"><span>財務交易系統</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#投資組合管理系統" id="投資組合管理系統" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="投資組合管理系統"><span>投資組合管理系統</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#洗錢防制解決方案" id="洗錢防制解決方案" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="洗錢防制解決方案"><span>洗錢防制解決方案</span></a>
            </div>
            <!-- ================ -->
            <div class="col-12 mb-3" data-labelledby="財務交易系統">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="投資組合管理系統">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="洗錢防制解決方案">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <!-- button area, max is 4 -->
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#kyc" id="kyc" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="kyc"><span>KYC 解決方案</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#視覺化圖型工具" id="視覺化圖型工具" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="視覺化圖型工具"><span>視覺化圖型工具</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#原始保證金解決方案" id="原始保證金解決方案" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="原始保證金解決方案"><span>原始保證金解決方案</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#外匯議價系統" id="外匯議價系統" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="外匯議價系統"><span>外匯議價系統</span></a>
            </div>
            <!-- ================ -->
            <div class="col-12 mb-3" data-labelledby="kyc">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="視覺化圖型工具">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="原始保證金解決方案">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="外匯議價系統">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
        ...
        <div id="service">
          ...
          <div class="row">
            <!-- button area, max is 4 -->
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#資訊委外服務" id="資訊委外服務" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="資訊委外服務"><span>資訊委外服務</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#系統整合開發" id="系統整合開發" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="系統整合開發"><span>系統整合開發</span></a>
            </div>
            <div class="col-12 col-md-3 mb-3 product-button">
              <a href="#政府專案服務" id="政府專案服務" class="border d-flex justify-content-center align-items-center py-2 px-1" role="button" data-product="政府專案服務"><span>政府專案服務</span></a>
            </div>
            <!-- ================ -->
            <div class="col-12 mb-3" data-labelledby="資訊委外服務">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="系統整合開發">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
            ...
            <div class="col-12 mb-3" data-labelledby="政府專案服務">
              <div class="border d-flex py-3">
                <div class="col-12 col-md-3 d-none d-md-block">
