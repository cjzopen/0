...
$pageName = "product";
$page['title']='衍生性金融商品評價系統免費諮詢|資通電腦';
$page['description']='想要更自主的驗證衍生金融商品價值能力？請填寫服務表單留下聯絡資訊，將有專員盡速與您聯繫提供服務。';
...
?>
  ...
  <section id="consult">
    ...
    <hr>
    <form id="consult_form" method="post" name="consult_form" onsubmit="return formCheck('Ares Cross Pricing System');">
<?php
