...
$pageName = "product";
$page['title']='TMU必備金融商品投資組合管理系統免費諮詢| 資通電腦';
$page['description']='想知道如何更有效率的掌握金融商品風險管理嗎？請填寫服務表單留下資訊，將有專員盡速與您聯繫提供服務。';
    ...
    <div class="ares-breadcrumb" aria-label="breadcrumb">
      <div class="container">
        <ul class="row" itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="../" itemprop="item"><span itemprop="name">ARES Portfolio System</span></a>
...
?>
  ...
  <section id="consult">
    ...
    <hr>
    <form id="consult_form" method="post" name="consult_form" onsubmit="return formCheck('ARES Portfolio System');">
<?php
