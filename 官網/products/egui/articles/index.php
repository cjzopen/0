...
$pageName = "product";
$page['title']='電子發票系統建置評估與整合方式分享 | 資通電腦';
$page['description']='提供企業導入電子發票系統，評估要點、該選加值中心代傳還是自建Turnkey系統？多公司、ERP與電子發票系統如何整合等電子發票相關知識。';
$page['canonical']='https://www.ares.com.tw/products/egui/articles/';
