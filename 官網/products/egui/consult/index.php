...
$pageName = "product";
$page['title']='電子發票系統eGUI免費諮詢 | 資通電腦';
$page['description']='有電子發票法規遵循以及台灣國稅局電子發票導入因應需求？請填寫服務表單留下聯絡資訊，將有專員盡速與您聯繫提供服務。';
...
?>
  ...
  <section id="consult" class="contact-area-hide">
    ...
    <hr>
    <form id="consult_form" method="post" name="consult_form" onsubmit="return formCheck('eGUI');">
<?php
