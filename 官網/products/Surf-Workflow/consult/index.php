...
$pageName = "product";
$page['title']='生產管理系統免費諮詢|資通電腦';
$page['description']='生產管理系統，線上免費諮詢。';
    ...
    <div class="ares-breadcrumb" aria-label="breadcrumb">
      <div class="container">
        <ul class="row" itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="../" itemprop="item"><span itemprop="name">生產管理系統</span></a>
...
?>
  ...
  <section id="consult" class="contact-area-hide">
    ...
    <hr>
    <form id="consult_form" method="post" name="consult_form" onsubmit="return formCheck('Surf-Workflow');">
<?php
