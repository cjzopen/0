...
<head>
    ...
    <title>Analyzer 相關文章 - 資通電腦股份有限公司</title>
    <meta name="description" content="資通電腦代理的 Analyzer – BI 動態決策分析工具，相關文章">
        ...
        <div class="ares-breadcrumb">
            <div class="container">
                <ul class="row">
                    ...
                    <li itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                        <a href="<?= @$nowUrl; ?>" itemprop="url"><span itemprop="title">相關文章</span></a>
                    </li>
                </ul>
            </div>
        </div>
