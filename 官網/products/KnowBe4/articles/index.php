...
$pageName = "product";
$page['title']='KnowBe4文章分享：提升您的資安意識與知識|資通電腦';
$page['description']='立即瀏覽我們的KnowBe4相關文章，掌握最新的資安趨勢、學習防範駭客攻擊的技巧，並保護您與企業的數位資產。';
$page['canonical']='https://www.ares.com.tw/products/knowbe4/articles/';
    ...
    <div class="ares-breadcrumb" aria-label="breadcrumb">
      <div class="container">
        <ul class="row" itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="../" itemprop="item"><span itemprop="name">KnowBe4</span></a>
