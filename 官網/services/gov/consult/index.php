...
$pageName = "service";
$page['title']='政府專案資訊系統整合免費諮詢 | 資通電腦';
$page['description']='想了解政府專案輔導、系統規劃與建置、系統整合、源碼檢測等政府專案服務項目嗎？歡迎填寫服務表單留下聯絡資訊，將有專人盡速與您聯繫提供服務。';
...
?>
  ...
  <section id="consult">
    ...
    <hr>
    <form id="consult_form" method="post" name="consult_form" onsubmit="return formCheck('GOV','/php/services_post.php');">
<?php
