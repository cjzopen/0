...
$pageName = "service";
$page['title']='程式開發、API 整合案例文章彙整，一看就懂 | 資通電腦';
$page['description']='各種程式軟體開發、系統整合的疑難雜症與解法，分享給你知。';
$page['canonical']='https://www.ares.com.tw/services/system-development-integration/articles/';
    ...
    <div class="ares-breadcrumb" aria-label="breadcrumb">
      <div class="container">
        <ul class="row" itemscope itemtype="http://schema.org/BreadcrumbList">
          ...
          <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
            <a href="../" itemprop="item"><span itemprop="name">系統整合開發</span></a>
