...
$pageName = "newsletter";
$page['title']='訂閱資通電子報 | 資通電腦';
$page['description']='訂閱電子報每個月中都會提供各式產品介紹與活動快訊，歡迎訂閱！';
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-6 col-sm-offset-3">
            ...
            <p class="danger erc"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> 請填寫 Email</p>
...
<script>
  $(function(){
    ...
    // 用 getScript 確保是新的js
    $.when(
      $.getScript( "/js/check-epaper.min.js" ),
      $.getScript( "./cancel.js" ),
