...
?>
  ...
  <section class="csr">
    ...
    <div class="container">
      ...
      <p>本公司主要耗能來自於外購電力，以及公務車汽、柴油。最近 2 年主要排放源為外購電力，占整體排放量 93% 以上，其餘為移動排放源（公務車之汽、柴油），屬於間接排放量（範疇二）。</p>
      <table class="table table-bordered">
      ...
      <p>本公司長年關注水資源節能環保議題，在節水計畫方面，從全面落實日常生活節約用水做起。</p>
      <table class="table table-bordered">
      ...
      <ul class="row">
        ...
        <li class="col-12 col-sm-6 col-md-4">
            <figure>
              <img width="350" height="200" loading="lazy" src="/img/about/csr/esg-7.jpg" alt="火災保險與定期消防測試" class="img-fluid ml-auto mr-auto">
              <figcaption>投保火險且定期消防測試與演練，保障員工與企業環境安全。</figcaption>
            </figure>
        </li>
      </ul>
    </div>
