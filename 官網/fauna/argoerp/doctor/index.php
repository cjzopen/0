...
<div id="all">
  ...
  <nav class="container-fluid">
    ...
    <!-- <a class="btn btn-info" href="../doctor/" role="button">ERP 達人觀點</a> -->
    <ol class="breadcrumb">
      <li><a href="/host/">host</a></li>
      <li><a href="/host/argoerp/">argoerp</a></li>
      ...
      <div class="row">
        ...
        <form id="contact_form" name="contact_form" method="post" action="">
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">網站</span>
            <input type="text" id="product" name="product" class="form-control" value="ArgoERP" disabled="disabled" aria-describedby="basic-addon1">
          </div>
          <br>
          <div class="input-group">
          ...
          <div class="input-group">
            ...
            <input type="text" id="date" name="date" class="form-control" placeholder="yyyy-mm" aria-describedby="basic-addon4">
          </div>
          <br>
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon6">作者</span>
            <input type="text" id="author" name="author" class="form-control" placeholder="曾音綺" aria-describedby="basic-addon6">
            <p class="form-control">留白：Dr.ERP</p>
          </div>
          <br>
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon5">作者圖片</span>
            <input type="text" id="img" name="img" class="form-control" placeholder="https://marketing.ares.com.tw/dm/newsletter-2017-05-ArgoERP/img/authors/melody.png" aria-describedby="basic-addon5">
            <p class="form-control">留白：Dr.ERP  ,無臉男：/img/events/author-photo2.png</p>
          </div>
          <br>
          <div class="input-group">
          ...
          <br>
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon8">*類別</span>
            <select name="tag" id="tag" class="form-control" aria-describedby="basic-addon8">
              <option value="ERP 達人專欄">ERP 達人專欄</option>
              <option value="技術交流">技術交流</option>
              <option value="產品特寫">產品特寫</option>
              <option value="焦點文章">焦點文章</option>
            </select>
          </div>
          <br>
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon9">文章圖片</span>
            <input type="text" id="photo" name="photo" class="form-control" placeholder="https://marketing.ares.com.tw/dm/newsletter-2017-07-HCP/images/og/focus.jpg">
          </div>
          <br>
...
function formCheck(){
  ...
  if(contact_form.summary.value.length<6){
  ...
  if(isPass){
    var user = {
      ...
      photo : contact_form.photo.value,
      tag : contact_form.tag.value
