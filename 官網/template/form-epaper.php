      ...
      <div class="float-box" style="padding-top: 2rem">
        <div class="container">
          <fieldset class="row justify-content-center">
            <div class="col-12 col-xs-12 col-sm-6 col-sm-offset-3">
      ...
      <div class="float-box" style="padding-top: 2rem">
        <div class="container text-center">
          <div class="row justify-content-center">
            ...
            <p class="danger er12 text-center col-12 col-xs-12"> 未驗證</p>
            <div class="col-12 col-xs-12 text-center">
              <div class="g-recaptcha" data-sitekey="6LcpDzsUAAAAAM2npS4P_R4_uYYeQHbPMIuBERk-" id="example1"></div>
            </div>
            <div class="col-12 col-xs-12 btn-ctrl" style="padding-top: 2rem">
