...
?>
        <li class="breadcrumb-item active" aria-current="page" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
          <a href="" itemprop="item" class="py-2 py-md-0 d-inline-block d-md-inline"><span itemprop="name">HR 系統</span></a>
    ...
    <aside class="supmenu d-print-none">
      <div class="container">
        <ul class="text-center mb-0" itemscope itemtype="http://data-vocabulary.org/WebPage">
          ...
          <li><a class="py-2 py-md-0" itemprop="relatedLink" href="/know-hr/how-choose/">如何選 HR 系統</a></li>
        </ul>
      </div>
    </aside>
      <header class="container entry-header">
        ...
        <section>
          <div class="container">
            <div class="row">
              <div class="col-12 col-md-12 col-lg-5 d-none d-md-block" aria-hidden="true">
