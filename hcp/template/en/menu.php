...
<?php
$lang1 = '/en/';
$lang2 = 'javascript:translatePage();" id="translateLink" title="并没有调整语意与图片，可能会出现不通顺之情况';
...
?>
    ...
    <nav class="container" id="menu" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
      <div class="row no-gutters justify-content-between">
        <div class="col-auto">
          <a class="d-flex align-items-center h-100" href="/" title="HCP 首頁" tabindex="-1">
<?php //echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/img/hcp-logo.svg'); ?>
        ...
        <div class="col-auto" id="sort">
          <ul class="row no-gutters justify-content-end mb-0">
            <li <?= substr($path,1,9) == 'index.php' ? 'class="act"' : '' ?> itemprop="name"><a itemprop="url" href="/"> 首 頁 </a></li>
