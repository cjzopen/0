...
$page['css']=array('/lib/swiper11/style.css','/public/css/drm.css');
...
?>
  <main>
    ...
    <section id="why" class="d-flex justify-content-center">
      <div id="compare">
        <h2 class="text-center">為何選擇 ARES PP？</h2>
        <div class="text-right d-md-none">
          <span class="prev slider-button x justify-content-center align-items-center">←</span>
          <span class="next slider-button justify-content-center align-items-center">→</span>
        </div>
        <div class="swiper" id="whys">
          <div class="swiper-wrapper">
            <div class="swiper-slide left">
              <div class="title h4">ARES PP 隱私保鑣</div>
              <div class="list d-flex align-items-center">
                <div><mark>不受影響</mark></div>
                <div class="item d-flex justify-content-center align-items-center flex-shrink-0">Office 版本變更</div>
              </div>
            </div>
            <div class="swiper-slide right">
              <div class="title h4">他廠產品</div>
              <div class="list d-flex align-items-center">
                <div>無法開啟或造成檔案損毀</div>
                <div class="item d-flex justify-content-center align-items-center flex-shrink-0 d-md-none">Office 版本變更</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <table class="table">
          <thead>
            <tr>
              <th></th>
              <th class="main-color">ARES PP 隱私保鑣</th>
              <th>他廠產品</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <th>Office 版本變更</th>
              <td class="main-color"><mark>不受影響</mark></td>
              <td>無法開啟或造成檔案損毀</td>
            </tr>
            <tr>
              <th>稽核紀錄呈現</th>
              <td class="main-color">圖形化呈現，一目了然</td>
              <td>文字記錄，不易理解</td>
            </tr>
            <tr>
              <th>實體列印管制</th>
              <td class="main-color">控制列印機台，文件不被任意列印</td>
              <td>無法控管，文件可被盜印</td>
            </tr>
            <tr>
              <th>浮水印功能</th>
              <td class="main-color">旗艦款：<br>文字、顏色、位置隨機出現</td>
              <td>基本款：<br>位置、顏色固定</td>
            </tr>
            <tr>
              <th>隱形浮水印</th>
              <td class="main-color">版權鑑識</td>
              <td>不支援</td>
            </tr>
            <tr>
              <th>雙重保護</th>
              <td class="main-color">MOTP 簡訊雙重驗證</td>
              <td>沒有配套方式</td>
            </tr>
            <tr>
              <th>文件地理追蹤</th>
              <td class="main-color">圖形化地理軌跡分析</td>
              <td>無法追蹤地理位置</td>
            </tr>
            <tr>
              <th>防止偷拍</th>
              <td class="main-color">自動偵測手機、平板、相機偷拍</td>
              <td>不支援</td>
            </tr>
            <tr>
              <th>行動文件支援系統</th>
              <td class="main-color">完整支援 windows、Mac、Linux、iOS、Android</td>
              <td>支援系統不完整</td>
            </tr>
            <tr>
              <th>行動加密文件備註功能</th>
              <td class="main-color">行動版加密文件也可新增備註</td>
              <td>不支援行動版備註功能</td>
            </tr>
            <tr>
              <th>加密遞延等候時間</th>
              <td class="main-color">核心底層加密，使用者無感，無加密遞延等候時間</td>
              <td>加密比未加密慢，影響使用者作業時間</td>
            </tr>
            <tr>
              <th>檔案格式支援</th>
              <td class="main-color">包括 Office、PDF、AutoCAD、SolidWorks、Pro/E…等。<br>不需額外費用，後台設定即可使用</td>
              <td>主要支援 Office、PDF，其餘設計圖檔需額外花費客製</td>
            </tr>
          </tbody>
        </table>
...
<script src="/public/js/drm.js" defer></script>
