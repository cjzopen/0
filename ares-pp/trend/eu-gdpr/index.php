...
$page['title'] = '快速瞭解歐盟GDPR，如何避免踩到紅線？';
$page['description'] = '不必自己摸索即可循序漸進防護 GDPR ，擊敗罰金最高、涵蓋範圍最廣的個資規範。';
$page['css']=array('/public/css/gdpr.css');
$canonical='https://ares-pp.ares.com.tw/trend/EU-GDPR/';
...
?>
  ...
  <main>
    <section class="bg-lazyload fff-color p-0 py-md-5" id="coming" data-image="/public/img/trend/gdpr/bg-eu-gdpr-1440.png" data-color="#fff" data-bgcolor="#102D4F">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-md-6 d-none d-md-block mt-5">
            <img src="/public/img/trend/gdpr/bg-EU-GDPR-2m.png" srcset="/public/img/trend/gdpr/bg-EU-GDPR-2m.png 1x, /public/img/trend/gdpr/bg-EU-GDPR-2.png 2x" alt="GDPR" class="img-fluid d-block mx-auto">
          </div>
        </div>
      </div>
    </section>
    <aside class="supmenu">
      <nav class="container">
        <ul class="text-center mb-0">
          ...
          <li><a href="#gov" accesskey="6">台灣相關產業</a></li>
            ...
            <div class="row">
                ...
                <div class="card s mx-auto h-100">
                  <div class="card-body">
                    <h3 class="card-title main-color d-flex">
                      <img class="lazy mr-3" data-src="/public/img/trend/gdpr/arespp-icon.svg" alt="*">
                      <span>ARES PP 隱私保鑣<br>文件加密軟體</span>
                    </h3>
                    <p>完善的電子文件資安防護，產出文件時就開始保護管制，徹底防護個資文件，維護資料重要防線。</p>
                    <ul class="disc">
                      <li>文件、檔案從源頭自然加解密</li>
                      <li>文件詳實稽核紀錄與軌跡</li>
                      <li>自動相機偵測，防手機偷拍</li>
              ...
              <div class="col-12 col-md-6 mb-4 mb-md-0">
                <div class="card s mx-auto h-100">
                  <div class="card-body">
                    <h3 class="card-title main-color d-flex">
                      <img class="lazy mr-3" data-src="/public/img/trend/gdpr/upki-icon.svg" alt="*">
        ...
        <div class="row counter-reset">
          <div class="col-12 col-md-4">
            <div class="my-3 mx-auto counter-item">
              <div class="fff-bg">
                <img class="lazy d-block mx-auto" data-src="/public/img/trend/gdpr/step-1.svg" alt="*">
              </div>
          ...
          <div class="col-12 col-md-4">
            <div class="my-3 mx-auto counter-item">
              <div class="fff-bg">
                <img class="lazy d-block mx-auto" data-src="/public/img/trend/gdpr/step-2.svg" alt="*">
              </div>
          ...
          <div class="col-12 col-md-4">
            <div class="my-3 mx-auto counter-item">
              <div class="fff-bg">
                <img class="lazy d-block mx-auto" data-src="/public/img/trend/gdpr/step-3.svg" alt="*">
              </div>
            ...
            <div class="row justify-content-center">
              <div class="col-12 col-md-4 mb-3">
                <div class="card mx-auto h-100">
                  <div class="card-body">
                    <h3 class="h4 card-title main-color d-flex align-items-center">
                      <img class="lazy mr-3 flex-constant" data-src="/public/img/trend/gdpr/tips-1.svg" alt="*">
                      <?php //echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/public/img/trend/gdpr/tips-1.svg'); ?>
                      <span>個資保護不完整</span>
                    </h3>
                    <ul class="disc">
                      <li>歐盟居民個資外洩</li>
                      <li>歐盟居民個資遭竊取</li>
                      <li>歐盟居民個資遭不正當存取或分享</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-4 mb-3">
                <div class="card mx-auto h-100">
                  <div class="card-body">
                    <h3 class="h4 card-title main-color d-flex align-items-center">
                      <img class="lazy mr-3 flex-constant" data-src="/public/img/trend/gdpr/tips-2.svg" alt="*">
                      <?php //echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/public/img/trend/gdpr/tips-2.svg'); ?>
                      <span>個資使用不正當</span>
                    </h3>
                    <ul class="disc">
                      <li>甲活動所蒐集的歐盟居民個資，被轉給無相關的乙活動使用</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-4 mb-3">
                <div class="card mx-auto h-100">
                  <div class="card-body">
                    <h3 class="h4 card-title main-color d-flex align-items-center">
                      <img class="lazy mr-3 flex-constant" data-src="/public/img/trend/gdpr/tips-3.svg" alt="*">
                      <?php //echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/public/img/trend/gdpr/tips-3.svg'); ?>
                      <span>個資權利未賦予</span>
                    </h3>
                    <ul class="disc">
                      <li>歐盟居民擁有更正、刪除個資的權利，若未給其應有的權利，則不符合規範</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-4 mb-3">
                <div class="card mx-auto h-100">
                  <div class="card-body">
                    <h3 class="h4 card-title main-color d-flex align-items-center">
                      <img class="lazy mr-3 flex-constant" data-src="/public/img/trend/gdpr/tips-4.svg" alt="*">
                      <?php //echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/public/img/trend/gdpr/tips-4.svg'); ?>
                      <span>個資防護技術與使用紀錄不足</span>
                    </h3>
                    <ul class="disc">
                      <li>不論歐盟居民個資是否遭外洩或竊取，只要資料安全防護技術不足、個資使用過程未被記錄，則與規範不符</li>
                    </ul>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-4 mb-3">
                <div class="card mx-auto h-100">
                  <div class="card-body">
                    <h3 class="h4 card-title main-color d-flex align-items-center">
                      <img class="lazy mr-3 flex-constant" data-src="/public/img/trend/gdpr/tips-5.svg" alt="*">
                      <?php //echo file_get_contents($_SERVER['DOCUMENT_ROOT'].'/public/img/trend/gdpr/tips-5.svg'); ?>
    ...
    <section class="m-size fff-color bg-lazyload" id="fine" data-image="/public/img/trend/gdpr/bg-eu-gdpr-4-1440.png" data-height="400px" data-color="#fff" data-bgcolor="#102D4F">
            ...
            <div class="row no-gutters mx-auto boxes">
              <div class="col-12 col-sm-6 col-md-4">
                <div class="ratio-box2 ratio-box">
                  <img loading="lazy" src="/public/img/trend/gdpr/application-1m-Air-Transport.png" srcset="/public/img/trend/gdpr/application-1m-Air-Transport.png 1x,/public/img/trend/gdpr/application-1-Air-Transport.png 2x" sizes="280px" alt="*">
                  <h4 class="text-center m-0 py-3 fff-color sub-bg">航空運輸</h4>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-md-4">
                <div class="ratio-box2 ratio-box">
                  <img loading="lazy" src="/public/img/trend/gdpr/application-2m-Financial.png" srcset="/public/img/trend/gdpr/application-2m-Financial.png 1x,/public/img/trend/gdpr/application-2-Financial.png 2x" sizes="280px" alt="*">
                  <h4 class="text-center m-0 py-3 fff-color sub-bg">金融業</h4>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-md-4">
                <div class="ratio-box2 ratio-box">
                  <img loading="lazy" src="/public/img/trend/gdpr/application-3m-Electronic-Information.png" srcset="/public/img/trend/gdpr/application-3m-Electronic-Information.png 1x,/public/img/trend/gdpr/application-3-Electronic-Information.png 2x" sizes="280px" alt="*">
                  <h4 class="text-center m-0 py-3 fff-color sub-bg">電信業</h4>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-md-4">
                <div class="ratio-box2 ratio-box">
                  <img loading="lazy" src="/public/img/trend/gdpr/application-4m-Internet-Retailer.png" srcset="/public/img/trend/gdpr/application-4m-Internet-Retailer.png 1x,/public/img/trend/gdpr/application-4-Internet-Retailer.png 2x" sizes="280px" alt="*">
                  <h4 class="text-center m-0 py-3 fff-color sub-bg">網路零售</h4>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-md-4">
                <div class="ratio-box2 ratio-box">
                  <img loading="lazy" src="/public/img/trend/gdpr/application-5m-Technology.png" srcset="/public/img/trend/gdpr/application-5m-Technology.png 1x,/public/img/trend/gdpr/application-5-Technology.png 2x" sizes="280px" alt="*">
                  <h4 class="text-center m-0 py-3 fff-color sub-bg">科技業</h4>
                </div>
              </div>
              <div class="col-12 col-sm-6 col-md-4">
                <div class="ratio-box2 ratio-box">
                  <img loading="lazy" src="/public/img/trend/gdpr/application-6m-Tourism.png" srcset="/public/img/trend/gdpr/application-6m-Tourism.png 1x,/public/img/trend/gdpr/application-6-Tourism.png 2x" sizes="280px" alt="*">
  ...
  $_html = $_html.'<article>
    <a class="row" href="'.$val['url'].'" rel="external">
      <div class="col-12 col-sm-3 col-lg-3">
        <figure class="ratio-box"><img class="lazy" data-src="'.$val['photo'].'" alt="'.$val['title'].'"></figure>
      </div>
