...
?>
  <main>
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-lg-5">
            ...
            <h1 class="main-color my-2">企業文件加密系統</h1>
    ...
    <section id="apply" class="bg-lazyload" data-image="/public/img/about/how-bg.png">
      <h2 class="text-center">內外加密無縫接軌，資料保護快速又安心</h2>
      <div class="container pb-5">
        <div class="row">
          <div class="col-12 col-md-6">
            <img loading="lazy" width="610" height="370" class="img-fluid" src="/public/img/about/arespp新功能.png" alt="新功能VOX">
          </div>
          <div class="col-12 col-md-6">
            <h3 class="main-color h4 mb-0">Office 文件直接加密寄送</h3>
            <p>使用者可在 Office 介面中，直接設定文件加密權限並 email 寄出，不需切換視窗，資料發佈一氣呵成。</p>
            <h3 class="main-color h4 mb-0">外發加密檔案可編輯</h3>
            <p>獲授權的供應商收到加密檔案可編輯修改，資安防護與作業需求一次滿足。擺脫需解密才能外發的資安風險。</p>
            <h3 class="main-color h4 mb-0">加密過程不怕壞檔</h3>
