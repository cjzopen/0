  ...
  <div class="container pt-4">
    <div class="row">
      <div class="col-12 col-sm-6 col-lg-3">
        ...
        <ul>
          <li class="my-1"><a class="py-1" href="/file/ARESPPMobileAPDReaderPublisherSetup_2.5.7243.26859_20200224.zip">隱私保鑣閱讀器</a></li>
        </ul>
      </div>
      <div class="col-12 col-sm-6 col-lg-3">
...
<script src="/public/js/form.js?4" defer fetchpriority="low"></script>
<script>
