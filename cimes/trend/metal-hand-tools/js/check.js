...
function formCheck(){
  ...
  var expr = /KiCKtalks|可尼酷樂|http:|https:|goo\.gl|0rz|bit\.ly|<|>|script|\.js|xss|ppt\.cc|service\@/i;
  ...
  if(isPass){
    ...
    $.ajax({
      ...
      if(data.ending == 'db'){
        ...
        alert('伺服器連線出錯，請嘗試用其它方試連絡客服，造成不便還請見諒');
        ...
        alert('SMTP出錯，請嘗試用其它方式諮詢，造成不便還請見諒');
