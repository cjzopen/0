...
const formArea = document.querySelector('#consult-section');
...
function formCheck(product,postUrl){
  ...
  if(isPass){
    ...
    $.ajax({
      ...
      data: user,
      beforeSend: function(){
        $('#consult_form .btn-ctrl').append('<div class="temp">送出中...</div>')
