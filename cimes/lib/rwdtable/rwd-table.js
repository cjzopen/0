(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownGroup = $('<div class="btn-group dropdown-btn-group text-right" />');
        this.$dropdownBtn = $('<button type="button" class="btn btn-cimes ml-2 dropdown-toggle" data-toggle="dropdown">' + this.options.i18n.display + ' <svg class="arrow-down" fill="#fff" height="12" viewBox="0 0 14 12" width="14" xmlns="http://www.w3.org/2000/svg"><polygon points="2,6 6,13 11,6"></polygon></svg></button>');
        ...
        if(this.options.addFocusBtn) {
            ...
            // Create focus btn
            this.$focusBtn = $('<button type="button" class="btn btn-cimes ml-2">' + this.options.i18n.focus + '</button>');
        ...
        if(this.options.addDisplayAllBtn) {
            ...
            this.$displayAllBtn = $('<button type="button" class="btn btn-outline-secondary ml-2">' + this.options.i18n.displayAll + '</button>');
            ...
            if (this.$table.hasClass('display-all')) {
                ...
                this.$displayAllBtn.addClass('btn-cimes');
            }
    ...
    ResponsiveTable.prototype.activateFocus = function() {
        ...
        if(this.$focusBtn){
            this.$focusBtn.toggleClass('btn-cimes');
        }
    ...
    ResponsiveTable.prototype.displayAll = function(activate, trigger) {
        if(this.$displayAllBtn){
            // add 'btn-primary' class to btn to indicate that display all is activated
            this.$displayAllBtn.toggleClass('btn-cimes', activate);
        }
            ...
            if ( $th.is('[data-priority]') && $th.data('priority') !== -1 ) {
                ...
                .change(function(){ // bind change event on checkbox
                    ...
                    if(that.$table.hasClass('display-all')){
                        ...
                        //switch off button
                        that.$displayAllBtn.removeClass('btn-cimes');
                    }
