<section id="consult-section" data-nosnippet>
  <form class="container" id="consult_form" name="consult_form" method="post" onsubmit="return formCheck();">
    ...
    <fieldset>
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-lg-4">
          ...
          <input type="text" name="howother" id="howother" style="display: none;">
        </div>
        <div class="col-12">
    ...
    <div class="container text-center btn-ctrl mt-3" id="submit-area">
      <button type="button" class="btn mb-3" id="submit-button"><span>立即預約專人諮詢</span></button>
     </div>
  </form>
</section>